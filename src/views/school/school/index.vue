<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="schoolList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="学校名称" align="center" prop="title" />
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="text" icon="el-icon-s-operation" @click="handleDepartment(scope.row)">学校结构</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="学校名称" prop="title">
          <el-input v-model="form.title" placeholder="请输入学校名称" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDepartment(row) {
      this.$router.push({ path: '/school/department/index/' + row.schoolId })
    }
  }
}
</script>
