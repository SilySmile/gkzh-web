...
<script>
import {listResult, getResultDetails,exportResult} from "@/api/cyzs/result";
...
export default {
    ...
    methods: {
        ...
        /** 导出按钮操作 */
        handleExport() {
            this.download('cyzs/answer/result/exportUserAnswerRecords' ,{},
